...
imax=99;  % to run the Multiscale Program once, with the parameters defined in NLD7ch_NewHeart_OPTIM.m
...
if typerun~=5 
    ...
    for i=1:1:15
       ...
       if imax~=1;disp(sprintf('  i =   %d', i));end;
       FactOptim=ones(1,14); 
       if i~=1;FactOptim(11)=0.5+(i-2)*0.1;end  
       FactOptim(11)=0.5+(i-2)*0.1;
       CalculatedVals=NLD7ch_NewHeart_OPTIM(FactOptim,typerun);
    end;
end
