...
TS=TSt-y(20)-y(21)-y(22)-y(23); ER=exp(-RLa*(L_inter_lv(t)-La)^2); 
Yh=fYv_lv*Yv*(1-exp(-gama*fgama_lv*(L_lv-y(25)-hwr)^2)); if (L_lv-y(25))>hwr; Yh=0.1*Yh; end;
fa=f*ER*ffa_lv; ga=Za+Yh; gd=Yd*exp(-Yc*(L_inter_lv(t)-Lc)); 
...
TS_rv=TSt-y(43)-y(44)-y(45)-y(46); ER=exp(-RLa*(L_inter_rv(t)-La)^2); 
Yh=fYv_rv*Yv*(1-exp(-gama*fgama_rv*(L_rv-y(48)-hwr)^2)); if (L_rv-y(48))>hwr; Yh=0.1*Yh; end;
fa=f*ER*ffa_rv; ga=Za+Yh; gd=Yd*exp(-Yc*(L_inter_rv(t)-Lc)); 
...
if (50<t) && (t<110) && iBeat==5
    
    y(35) = y(35) + 9.5; %10
    
    Qmt=(y(35) - Plv)/Rmt; Qmt=Qmt*(Qmt > 0);

   %=(y(35)+9 - Plv)/Rmt ; Qmt=Qmt*(Qmt > 0); %7
   %Qmt=(y(35) - Plv)/Rmt + 9.5/Rmt ; Qmt=Qmt*(Qmt > 0); %7d
   %Qmt = Qmt+0.2; % 7b + 7c on enregistre aussi les 10 beats suivants (retour éq.)
